(window.webpackJsonp = window.webpackJsonp || []).push([[8], {
    337: function (t, e, n) {
        ...
        n.r(e);
        n(310), n(92), n(91);
        var a = n(42), s = n(314), r = n(308), i = n(311), o = n.n(i), l = {
            name: "Docs", mixins: [s.a, r.a], data: function () {
                return {loading: !0, currentNetwork: null, tokenType: "SimpleKIP20", token: {}}
            }, computed: {
                sourceCode: function () {
                    return "/kip20-generator/source-code/".concat(this.contracts.token.contractName, ".dist.txt")
                }, controlFlow: function () {
                    return "/kip20-generator/analysis/control-flow/".concat(this.contracts.token.contractName, ".png")
                }, inheritanceTree: function () {
                    return "/kip20-generator/analysis/inheritance-tree/".concat(this.contracts.token.contractName, ".png")
                }, uml: function () {
                    return "/kip20-generator/analysis/uml/".concat(this.contracts.token.contractName, ".svg")
                }
            }, mounted: function () {
                this.initDapp()
            }, methods: {
                initDapp: function () {
                        ...
                        return regeneratorRuntime.wrap((function (e) {
                            for (; ;) switch (e.prev = e.next) {
                                ...
                                case 3:
                                    ...
                                    break;
                                case 5:
                                    e.prev = 5, e.t0 = e.catch(0), console.log(e.t0), t.makeToast("Some error occurred", e.t0, "danger");
                                case 9:
                                case"end":
                                    return e.stop()
                            }
                    ...
                    return Object(a.a)(regeneratorRuntime.mark((function e() {
                        return regeneratorRuntime.wrap((function (e) {
                            for (; ;) switch (e.prev = e.next) {
                                case 0:
                                    t.initToken(t.tokenType), t.token = t.tokenDetails.find((function (e) {
                                        return e.name === t.tokenType
                                    })), t.token.version = o.a.version, t.loading = !1;
                                case 4:
                                case"end":
                                    return e.stop()
                            }
        ...
        }, c = n(40), u = Object(c.a)(l, (function () {
            var t = this, e = t.$createElement, n = t._self._c || e;
            return n("div", [n("b-jumbotron", {
                staticClass: "mb-0 flickr-gradient",
                attrs: {"text-variant": "white", header: "KIP20 Token Documentation", fluid: ""},
                scopedSlots: t._u([{
                    key: "lead", fn: function () {
                        return [t._v("\n            KIP20 Token Generator Documentation.\n            "), n("br"), t._v("\n            Discover more details about different KIP20 Token Types, ABI, source code and analysis report.\n        ")]
                    }, proxy: !0
                }])
            }), t._v(" "), n("b-row", {
                staticClass: "mx-0",
            ...
            }, [t.loading ? n("div", {staticClass: "text-center p-5"}, [n("ui--loader", {attrs: {loading: !0}})], 1) : t._e(), t._v(" "), t.loading ? t._e() : n("b-card", {
                attrs: {
                    "bg-variant": "transparent",
                    "border-variant": "0"
                }
            }, [n("b-row", [n("b-col", {attrs: {lg: "8"}}, [n("b-card", {
                staticClass: "mt-3",
                attrs: {header: "Token Type", "header-bg-variant": "dark", "header-text-variant": "white"}
            }, [n("b-form-group", {
                attrs: {
                ...
                attrs: {id: "tokenType", size: "lg"},
                on: {input: t.loadToken},
                model: {
                    value: t.tokenType, callback: function (e) {
                        t.tokenType = e
                    }, expression: "tokenType"
                }
            }, t._l(t.tokenList, (function (e, a) {
                return n("option", {domProps: {value: a}}, [t._v(t._s(e.contractName))])
            })), 0)], 1)], 1), t._v(" "), n("b-card", {
                staticClass: "mt-3",
                attrs: {
                    "no-body": "",
            ...
            }, [n("b", [t._v(t._s(t.contracts.token.contractName) + ".svg")])])], 1), t._v(" "), n("b-list-group-item", {staticClass: "py-4"}, [n("div", {staticClass: "form-group"}, [n("label", [t._v("ABI:")]), t._v(" "), n("b-form-textarea", {
                attrs: {
                    readonly: "",
                    "no-resize": "",
                    rows: "5"
                }, model: {
                    value: t.contracts.token.stringifiedAbi, callback: function (e) {
                        t.$set(t.contracts.token, "stringifiedAbi", e)
                    }, expression: "contracts.token.stringifiedAbi"
                }
            })], 1)])], 1)], 1)], 1), t._v(" "), n("b-col", {attrs: {lg: "4"}}, [n("b-card", {
                staticClass: "mt-3",
                attrs: {
                    "no-body": "",
                    "bg-variant": "light",
                ...
                return e.name ? n("b-card", {
                    ...
                    staticClass: "p-4",
                    attrs: {id: "method-" + a}
                }, [n("b-card-sub-title", [t._v("\n                                        Type: " + t._s(e.type) + "\n                                    ")]), t._v(" "), e.stateMutability ? n("b-card-text", [t._v("\n                                        State Mutability: " + t._s(e.stateMutability) + "\n                                    ")]) : t._e(), t._v(" "), e.inputs && e.inputs.length > 0 ? n("b-card-text", [n("p", [t._v("Inputs:")]), t._v(" "), n("ul", t._l(e.inputs, (function (e, a) {
                    return n("li", {key: a}, [n("b", [t._v(t._s(e.type))]), t._v(" " + t._s(e.name) + "\n                                            ")])
                })), 0)]) : t._e(), t._v(" "), e.outputs && e.outputs.length > 0 ? n("b-card-text", [n("p", [t._v("Outputs:")]), t._v(" "), n("ul", t._l(e.outputs, (function (e, a) {
                    return n("li", {key: a}, [n("b", [t._v(t._s(e.type))]), t._v(" " + t._s(e.name) + "\n                                            ")])
                })), 0)]) : t._e()], 1)], 1) : t._e()
            })), 1)], 1)], 1)], 1)], 1)], 1), t._v(" "), n("b-row", {staticClass: "bg-light text-dark mx-0"}, [n("b-col", {
                staticClass: "mb-3 text-center",
                attrs: {lg: "10", "offset-lg": "1"}
            }, [n("h2", {staticClass: "pt-5 mb-4 font-weight-lighter text-dark"}, [t._v("Ready to deploy your KIP20 Token?")]), t._v(" "), n("p", {staticClass: "font-weight-light"}, [t._v("\n                Try building your KIP20 Token in less than a minute. You can try on Test Network before to go live.\n            ")]), t._v(" "), n("b-button", {
