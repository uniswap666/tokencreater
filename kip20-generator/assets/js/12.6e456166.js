(window.webpackJsonp = window.webpackJsonp || []).push([[12], {
    339: function (t, e, a) {
        "use strict";
        a.r(e);
        var n = {name: "Features"}, o = a(40), s = Object(o.a)(n, (function () {
            var t = this, e = t.$createElement, a = t._self._c || e;
            return a("div", {staticClass: "features-table"}, [a("b-row", {staticClass: "mb-5"}, [a("b-col", {
                attrs: {
                    lg: "10",
                    "offset-lg": "1"
                }
            }, [a("h4", {staticClass: "text-center font-weight-light text-light"}, [t._v("\n                You will be able to choose between several features.\n            ")]), t._v(" "), a("p", {staticClass: "text-center font-weight-light text-light"}, [t._v("\n                What are your Token requirements?\n            ")])])], 1), t._v(" "), a("b-card-group", {attrs: {deck: ""}}, [a("b-card", {
                staticClass: "mb-3",
                attrs: {"sub-title": "Detailed"}
            }, [a("b-card-text", [t._v("\n                Your Token will be fully compliant with the KIP20 definition and\n                compatible with any KIP20 wallet all around the world.\n                It will have a name, a symbol and a decimals amount.\n            ")])], 1), t._v(" "), a("b-card", {
                staticClass: "mb-3",
                attrs: {"sub-title": "Capped"}
            ...
            }, [a("b-card-text", [t._v("\n                The Operable Token is a KIP20 compatible Token that can make a\n                callback on the receiver contract to notify token transfers or token approvals.\n            ")])], 1), t._v(" "), a("b-card", {
                staticClass: "mb-3",
                attrs: {"sub-title": "Token Recover"}
            }, [a("b-card-text", [t._v("\n                There are lots of tokens lost forever into Smart Contracts.\n                It allows the contract owner to recover any KIP20 token sent into the contract for error.\n            ")])], 1)], 1), t._v(" "), a("b-row", [a("b-col", {attrs: {lg: "12"}}, [a("b-alert", {
                staticClass: "mb-3",
                attrs: {variant: "warning", show: ""}
            }, [a("h4", {staticClass: "alert-heading"}, [t._v("Copyright")]), t._v(" "), a("p", [t._v("\n                    Deploying HelloKIP20 for FREE or SimpleKIP20, a link pointing to this page will be added to\n                    your contract.\n                    Your Token will be fully compliant with the KIP20 Standard and you can use it without issues.\n                    It is only a little credit to advertise KIP20 Token Generator.\n                    You can remove it by choosing an advanced Token type.\n                ")])])], 1), t._v(" "), a("b-col", {
                staticClass: "mt-4",
                attrs: {lg: "6", "offset-lg": "3"}
            }, [a("p", {staticClass: "text-center text-light"}, [t._v("\n                Learn more in\n                "), a("a", {
                directives: [{
                    name: "smooth-scroll",
                    rawName: "v-smooth-scroll",
                    value: {duration: 1e3, offset: 0, updateHistory: !1},
                    expression: "{ duration: 1000, offset: 0, updateHistory: false }"
                }], staticClass: "text-reset", attrs: {href: "#faq"}
